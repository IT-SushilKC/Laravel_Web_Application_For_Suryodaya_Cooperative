            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading   d-flex  justify-content-between">
                        ...
                        <div class="col-md-6">
                            <h4>Shareholder Member</h4>
                        </div>
                        <div class="col-md-6">
                            <a href="{{ route('admin.showmembership') }}" class="btn btn-success mb-3">All Shareholders</a>

                        </div>
                    </div>

                    <div class="panel-body">
                        <form class="form-horizontal" action="{{ route('admin.membershipadd') }}" method="POST"
